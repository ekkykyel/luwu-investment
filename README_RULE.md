...
- *Single Source of Truth* untuk data investasi HANYA berasal dari **Firebase Firestore**. 
- Data spasial raksasa (jalan, batas wilayah, tutupan lahan) WAJIB dimuat secara lokal dari folder `/public/`.

## 2. 🛡️ HONEST FALLBACK (PENANGANAN ERROR YANG JUJUR)
- Jika terjadi *Error 429*, *Firebase Quota Exceeded*, koneksi terputus, atau *database* kosong, Anda **DILARANG KERAS** menyuntikkan "Premium Fallback" atau data cadangan buatan.
