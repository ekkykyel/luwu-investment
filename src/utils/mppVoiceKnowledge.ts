...
function internalResolveMppVoiceQuery(query: string, lang: 'id' | 'en' | 'zh' = 'id'): VoiceAssistantResponse {
  ...
  if (lang === 'en') {
    ...
    return {
      ...
      speechText: `Welcome to MPP Simpurusiang Luwu. Regarding your question on "${query}", our integrated service center hosts 19 government and public agencies with over 120 services. Our customer service desk at the Ground Floor Lobby is ready to guide you Monday through Thursday from 07:30 to 16:00, and Friday from 07:30 to 16:30 local time.`,
      query,
      persyaratan: [
