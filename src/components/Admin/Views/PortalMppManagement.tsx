...
export default function PortalMppManagement({ isDark: propIsDark }: { isDark?: boolean }) {
  ...
  const [contacts, setContacts] = useState({
    ...
    working_hours_mon_thu: "Senin - Kamis: 08:00 - 15:30 WITA",
    working_hours_fri: "Jumat: 08:00 - 16:00 WITA",
              ...
              {isLoadingTenants ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {tenants.map(t => (
                    <div
                      key={t.id}
                      className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 flex items-start gap-3 hover:border-slate-700 transition-all group"
                    >
                      <img
                      ...
                      <div className="flex items-center gap-1 bg-slate-900/80 p-1 rounded-lg border border-slate-800 shrink-0 opacity-0 group-hover:opacity-100 transition-all">
                        <button
                          onClick={() => {
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-md hover:bg-slate-800 text-rose-400 hover:text-rose-300 transition-colors cursor-pointer"
