...
export const getMenusByRole = (role: string): MenuGroup[] => {
  ...
  const allowedIdsByRole: Record<string, string[]> = {
    ...
    admin_puptr: ['overview', 'pkkpr_sync_monitor', 'verifikasi_pkkpr', 'gis_spatial', 'spatial_analytics'],
    admin_pertanian: ['overview', 'pkkpr_sync_monitor', 'verifikasi_pertanian', 'gis_spatial'],
    admin_oss: ['overview_perizinan', 'pkkpr_sync_monitor', 'realisasi_nib'],
