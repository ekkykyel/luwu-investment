...
{/* The Finisher Modal */}
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900/40 p-6 border border-slate-200 dark:border-slate-800/80">
              ...
              <div className="relative space-y-3">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black tracking-wider uppercase text-emerald-700 dark:text-emerald-400 bg-emerald-400/10 border border-emerald-500/20 shadow-[0_0_15px_rgba(16,185,129,0.2)]">
                  🗺️ MANAJEMEN SPASIAL & GIS LUWU
                </span>
                <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Enterprise GIS & Analisis Keruangan</h1>
                <p className="text-slate-800 dark:text-slate-200 text-sm max-w-3xl leading-relaxed">
                  Kelola layer geospasial, tutupan lahan, RTRW, dan analisis jangkauan infrastruktur untuk seluruh wilayah Kabupaten Luwu.
                </p>
              </div>
            </div>
            <div className="p-6 rounded-2xl bg-white/90 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/60 dark:border-white/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-300 space-y-4">
              <h3 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
                ...
                Peta Spasial Interaktif DPMPTSP Luwu
              </h3>
              <div className="w-full h-[350px] md:h-[500px] rounded-xl relative overflow-hidden border border-slate-200 dark:border-slate-800">
                <DalakMap isDarkMode={true} complaints={complaints} />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {/* Interactive Geoportal Map */}
            <div className="p-6 rounded-3xl bg-white/90 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/60 dark:border-white/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] space-y-4">
              <h3 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
                <Map size={18} className="text-emerald-500" />
                Pratinjau Geoportal 3D Spasial Luwu
              </h3>
              <div className="w-full h-[450px] md:h-[600px] rounded-2xl relative overflow-hidden border border-slate-200 dark:border-slate-800">
                <DalakMap isDarkMode={true} complaints={complaints} />
              </div>
            </div>
          </div>
