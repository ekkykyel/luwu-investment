  ...
  const stepsData = [
    {
      ...
      railColor: "via-sky-500",
      activeBg: "bg-sky-500/10 text-sky-700 dark:text-sky-300 border-sky-500/30",
      dotColor: "bg-sky-500",
      badgeClass: "bg-sky-50 dark:bg-sky-500/10 text-sky-700 dark:text-sky-300 border-sky-200 dark:border-sky-500/20",
    ...
    },
    {
      ...
      railColor: "via-emerald-500",
      activeBg: "bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 border-emerald-500/30",
    ...
    },
    {
      ...
      railColor: "via-teal-500",
      activeBg: "bg-teal-500/10 text-teal-700 dark:text-teal-300 border-teal-500/30",
      dotColor: "bg-teal-500",
      badgeClass: "bg-teal-50 dark:bg-teal-500/10 text-teal-700 dark:text-teal-300 border-teal-200 dark:border-teal-500/20",
    ...
    },
    {
      ...
      railColor: "via-indigo-500",
      activeBg: "bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 border-indigo-500/30",
      dotColor: "bg-indigo-500",
      badgeClass: "bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 border-indigo-200 dark:border-indigo-500/20",
                  ...
                  >
                    <TiltCard
                      ...
                      className={`w-full h-full rounded-[26px] sm:rounded-[28px] border overflow-hidden flex flex-col group/card
                                  ...
                                  ${isDark ? 'bg-slate-900/90 border-white/10 shadow-[0_18px_50px_rgba(0,0,0,0.6)]' : 'bg-white/95 border-slate-200/90 shadow-[0_16px_45px_rgba(15,23,42,0.07)]'}`}
                    >
                      ...
                      <div className="h-60 sm:h-64 overflow-hidden relative w-full">
                        ...
                        <div className="absolute top-3 inset-x-3 flex items-center justify-between gap-1.5 z-10">
                          ...
                          <div className="flex items-center gap-1.5">
                            {(inv.smartData?.aiScore || inv.smartData?.ai_score) && (
                              <div className="flex items-center gap-1 px-2.5 py-1 rounded-xl bg-slate-950/80 backdrop-blur-md border border-amber-400/40 text-white shadow-md shrink-0">
                            ...
                            {(() => {
                              ...
                              return isTier1 ? (
                                ...
                                <div 
                                  className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl text-[10px] font-extrabold bg-amber-950/90 text-amber-300 border border-amber-400/60 backdrop-blur-md shadow-md"
                        ...
                        <div className="absolute bottom-3 inset-x-3 flex items-center justify-between text-xs text-white z-10 pointer-events-none">
                          <div className="w-full flex items-center justify-between bg-slate-950/80 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/15 shadow-md">
                      ...
                      <div className="p-5 sm:p-6 flex flex-col flex-grow">
                            ...
                            <div className="grid grid-cols-3 gap-2 sm:gap-2.5 mb-4.5">
                              ...
                              <div className={`p-2.5 rounded-2xl border text-center flex flex-col items-center justify-between transition-all duration-300 ${
                                ...
                                <div className="flex items-center gap-1 text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1">
                                  <div className="w-4 h-4 rounded-full bg-blue-500/10 dark:bg-blue-400/10 flex items-center justify-center shrink-0">
                        ...
                        <div className={`mt-auto pt-3.5 flex flex-col gap-2.5 border-t ${isDark ? 'border-slate-800/80' : 'border-slate-100'}`}>
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <button
                              ...
                              className="min-h-[38px] px-2 py-1.5 rounded-xl text-xs font-bold bg-emerald-500/10 dark:bg-emerald-950/40 hover:bg-emerald-500/20 dark:hover:bg-emerald-900/50 text-emerald-800 dark:text-emerald-300 border border-emerald-500/30 flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-xs group/btn"
                            ...
                            <button
                              ...
                              className="min-h-[38px] px-2 py-1.5 rounded-xl text-xs font-bold bg-amber-500/10 dark:bg-amber-950/40 hover:bg-amber-500/20 dark:hover:bg-amber-900/50 text-amber-800 dark:text-amber-300 border border-amber-500/30 flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-xs group/btn"
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
              <span className={`inline-flex items-center gap-2 px-4 py-1.5 min-h-[44px] rounded-full text-xs font-bold uppercase tracking-wider mb-4 border backdrop-blur-md shadow-xs ${isDark ? "bg-sky-500/10 text-sky-400 border-sky-500/30" : "bg-sky-50 text-sky-700 border-sky-200"}`}>
                <Compass size={14} className="text-sky-500 animate-spin-slow" /> {t("roadmap.tag", "Alur Legalitas & Regulasi Luwu")}
              </span>
              ...
              <div className="h-1.5 w-20 bg-gradient-to-r from-sky-500 via-emerald-500 to-indigo-500 rounded-full mb-4 mx-auto" />
            ...
            <div className="mb-10 sm:mb-12 relative">
              ...
              <div className="hidden sm:block absolute top-7 inset-x-12 lg:inset-x-20 h-1 bg-slate-200 dark:bg-slate-800 rounded-full z-0">
                <div
                  className="h-full bg-gradient-to-r from-sky-500 via-emerald-500 to-indigo-500 rounded-full transition-all duration-500"
              ...
              return (
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch w-full">
                  ...
                  <div className="hidden lg:flex lg:col-span-5 flex-col gap-3.5 relative">
                    ...
                    <div className="absolute left-[31px] top-6 bottom-6 w-0.5 bg-gradient-to-b from-sky-500 via-emerald-500 to-indigo-500 z-0 opacity-40 dark:opacity-30" />
                      ...
                      return (
                        <motion.button
                          ...
                          className={`w-full text-left p-4 rounded-2xl border flex items-center gap-4 transition-all duration-300 relative z-10 group ${
                            isActive
                              ? `bg-white dark:bg-slate-900 border-slate-300 dark:border-slate-700 shadow-xl ${step.shadow} ring-1 ring-slate-300 dark:ring-slate-700`
                              : `bg-white/80 dark:bg-slate-900/60 border-slate-200/80 dark:border-slate-800/80 hover:bg-white dark:hover:bg-slate-900 hover:border-slate-300 dark:hover:border-slate-700 shadow-xs`
                          }`}
                        >
                          ...
                          <div className="relative shrink-0">
                            ...
                            <div
                              className={`w-12 h-12 rounded-full flex items-center justify-center font-mono font-bold text-sm relative z-10 transition-all duration-300 ${
                                isActive
                                  ? `bg-gradient-to-br ${step.gradient} text-white ring-2 ring-white dark:ring-slate-900 ${step.shadow} scale-105`
                                  : isCompleted
                                  ? `bg-emerald-500 text-white ring-1 ring-emerald-300 dark:ring-emerald-700`
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center justify-between gap-2 mb-1">
                              <h4 className={`text-sm font-bold tracking-tight truncate transition-colors ${isActive ? "text-slate-900 dark:text-white" : "text-slate-700 dark:text-slate-300"}`}>
                                {step.title}
                              </h4>
                              <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold shrink-0 border ${
                                isActive ? step.badgeClass : "bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-700"
                              }`}>
                                {step.duration}
                              </span>
                            </div>
                            <p className={`text-xs ${textMuted} truncate`}>{step.agency}</p>
                          </div>
                          ...
                          <ChevronRight
                            ...
                            className={`shrink-0 transition-transform duration-300 ${
                              isActive ? "translate-x-1 text-sky-500 dark:text-sky-400" : "text-slate-400 dark:text-slate-600 group-hover:translate-x-0.5"
                            }`}
                          />
                        </motion.button>
                      );
