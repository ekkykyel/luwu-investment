          ...
          <div>
            <h4
              className={`text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 ${
                isDark ? "text-emerald-700 dark:text-emerald-400" : "text-emerald-800"
              }`}
            >
            ...
            <span
              className={`text-[11px] ${
                isDark ? "text-slate-600 dark:text-slate-400" : "text-slate-600"
              }`}
            >
        ...
        <div className="relative">
          <label
            className={`text-[10px] font-bold uppercase block mb-1 ${
              isDark ? "text-slate-600 dark:text-slate-400" : "text-slate-800 dark:text-slate-200"
            }`}
          >
          ...
          <div className="relative">
            <Search
              ...
              className={`absolute left-3 top-1/2 -translate-y-1/2 ${
                isDark ? "text-slate-600 dark:text-slate-400" : "text-slate-600 dark:text-slate-400"
              }`}
            />
            <input
              type="text"
      ...
      >
        ...
        >
          ...
          <span className="flex items-center gap-1.5">
            <Award
              size={14}
              className={isDark ? "text-amber-700 dark:text-amber-400" : "text-amber-600"}
            />
        ...
        >
          ...
          <span className="flex items-center gap-1.5">
            <ShieldCheck
              size={14}
              className={isDark ? "text-emerald-700 dark:text-emerald-400" : "text-emerald-700"}
            />
