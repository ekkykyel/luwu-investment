      ...
      <button
        ...
        className={`w-full h-full p-2.5 rounded-xl border text-left text-xs transition-all flex flex-col gap-1 cursor-pointer ${
          isSelected
            ...
            : isDarkMode ? "bg-slate-900 border-slate-800 text-slate-300 hover:bg-slate-800/60" : "bg-slate-50 border-slate-200 text-slate-800 dark:text-slate-200 hover:bg-slate-100"
        }`}
      >
        ...
        <div className="flex justify-between items-center text-[9.5px] text-slate-600 dark:text-slate-400 font-mono w-full">
