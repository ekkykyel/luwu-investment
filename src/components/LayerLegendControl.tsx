...
export default function LayerLegendControl({ 
  ...
  return createPortal(
    <div className={`m-2 sm:m-3 mt-[138px] sm:mt-[128px] md:mt-24 ${
      ...
      <AnimatePresence mode="wait">
        {!isLayerPanelOpen ? (
          ...
          <motion.div
            ...
            className={`p-4 rounded-2xl shadow-2xl border origin-left transition-all duration-300 w-84 sm:w-96 max-w-[calc(100vw-2.5rem)] md:max-w-[390px] ${
              isDarkMode 
          ...
          >
            ...
            {activeTab === "controls" && (
              <div className="space-y-3.5 max-h-[calc(100dvh-240px)] md:max-h-85 overflow-y-auto custom-scrollbar pr-1">
                {/* Base Map Selection */}
                {setMapMode && (
            ...
            {activeTab === "layers" && (
              <>
                ...
                {/* Layer Items List */}
                <div className="overflow-y-auto custom-scrollbar pr-1.5 max-h-[calc(100dvh-240px)] md:max-h-80 space-y-2">
            ...
            {activeTab === "symbology" && (
              <div className="flex flex-col">
                ...
                <div className="overflow-y-auto custom-scrollbar pr-1 max-h-[calc(100dvh-240px)] md:max-h-80 space-y-2">
