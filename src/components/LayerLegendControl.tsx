        ...
        {!isLayerPanelOpen ? (
          ...
          <motion.button
            ...
            className={`flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl shadow-xl border transition-all duration-300 hover:scale-105 active:scale-95 group ${
              isDarkMode 
                ? "bg-slate-900/90 border-white/15 text-white shadow-black/80 backdrop-blur-2xl hover:border-indigo-400/80 hover:bg-slate-800/90 ring-1 ring-white/10" 
                : "bg-white/90 border-slate-900/15 text-slate-900 shadow-xl shadow-slate-900/10 backdrop-blur-2xl hover:border-indigo-500 hover:bg-white ring-1 ring-slate-900/5"
            }`}
          >
            <div className="relative flex items-center justify-center">
              <div className="p-1 rounded-lg bg-indigo-500/10 dark:bg-indigo-500/20 text-indigo-500">
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <span className="text-[9px] text-slate-500 dark:text-slate-400 font-mono flex items-center gap-1">
                ...
                {activeCount} Layer Aktif {isFilterActive ? "• Clip ✂️" : ""}
              </span>
            </div>
