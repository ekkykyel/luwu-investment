        ...
        <div className="overflow-x-auto custom-scrollbar">
          <table className="w-full text-left text-xs whitespace-nowrap">
            <thead className="bg-slate-50 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-700/50">
              <tr>
                <th className="px-4 py-3 font-bold text-slate-700 dark:text-slate-300">Waktu Eksekusi</th>
                <th className="px-4 py-3 font-bold text-slate-700 dark:text-slate-300">Aksi</th>
                <th className="px-4 py-3 font-bold text-slate-700 dark:text-slate-300">Target Tabel</th>
                <th className="px-4 py-3 font-bold text-slate-700 dark:text-slate-300">Operator ID</th>
                <th className="px-4 py-3 font-bold text-slate-700 dark:text-slate-300 text-right">Detail</th>
              </tr>
            </thead>
                ...
                logs.map((log) => (
                  <React.Fragment key={log.id}>
                    <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5 text-slate-600 dark:text-slate-400 font-mono text-[10px]">
                    ...
                    {expandedId === log.id && (
                      <tr className="bg-slate-50/50 dark:bg-slate-900/60">
                        <td colSpan={5} className="px-4 py-4 border-b border-slate-200 dark:border-slate-800 shadow-[inset_0_4px_6px_-4px_rgba(0,0,0,0.1)]">
                          ...
                          <div className="mt-3 flex items-center gap-1.5 text-[10px] font-mono text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800 inline-flex px-2 py-1 rounded border border-slate-200 dark:border-slate-700">
                            <Hash className="w-3 h-3" />
                            Record ID: <span className="font-bold text-slate-700 dark:text-slate-300">{log.record_id}</span>
                          </div>
                        </td>
                      </tr>
                    )}
